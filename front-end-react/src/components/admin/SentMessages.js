...
function SentMessages(props) {
  ...
  <Card ><div style={{textAlign:"right"}}>Date: {props.date_}</div><Accordion.Toggle as={Card.Header} eventKey="1" style={{backgroundColor:"white"}}>
  <Button  variant="outline-dark" onClick={editHandler}>Edit message
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
              ...
              <Col sm={3} >
                <Button variant="success" onClick={updateHandler}>Update
                <svg style={{marginLeft:"10px"}} xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-check-square" viewBox="0 0 16 16">
