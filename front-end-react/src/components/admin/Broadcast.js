...
// date.setDate(date.getDate()+20)
    ...
    return (
     ...
     <Form.Group id="title">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" style={{marginRight:"10px"}} width="20" height="20" fill="currentColor" class="bi bi-megaphone" viewBox="0 0 16 16">
